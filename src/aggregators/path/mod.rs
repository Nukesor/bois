...
impl<'a> WalkContext<'a> {
    pub fn for_host(
        ...
        Ok(WalkContext {
            ...
            defaults: Defaults {
                owner: host_config.permission_defaults.owner.clone(),
                group: host_config.permission_defaults.group.clone(),
                file_mode: host_config.permission_defaults.file_mode,
                directory_mode: host_config.permission_defaults.directory_mode,
            },
    ...
    pub fn for_trait(
        ...
        Ok(WalkContext {
            ...
            defaults: Defaults {
                owner: trait_config.permission_defaults.owner.clone(),
                group: trait_config.permission_defaults.group.clone(),
                file_mode: trait_config.permission_defaults.file_mode,
                directory_mode: trait_config.permission_defaults.directory_mode,
            },
