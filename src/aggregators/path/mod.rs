...
impl<'a> WalkContext<'a> {
    ...
    pub fn for_trait(
        ...
        Ok(WalkContext {
            ...
            defaults: Defaults {
                owner: trait_config.file_defaults.owner.clone(),
                group: trait_config.file_defaults.group.clone(),
                file_mode: trait_config.file_defaults.file_mode,
                directory_mode: trait_config.file_defaults.directory_mode,
            },
